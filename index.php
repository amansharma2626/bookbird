...
if(isset($_POST['submit']))
{
  ...
  else if($_POST['submit']=="register")
  {
        ...
        $mobile=$_POST['register_number'];
        if(strlen($username)<=4 || strlen($password)<=4){
            print'
               <script type="text/javascript">alert("username or password length should be more than 4");</script>
                    ';
        }
        else{
            ...
            {
              $query ="INSERT INTO users VALUES ('$username','$password','$mobile')";
                      ...
                      <div class="modal-content">
                          ...
                          <div class="modal-body">
                                        <form class="form" role="form" method="post" action="index.php" accept-charset="UTF-8">
                                            ...
                                            <div class="form-group">
                                                <label class="sr-only" for="number">mobile no. *</label>
                                                <input type="number" name="register_number" class="form-control"  placeholder="mobile no." required>
                                            </div>
                                            <div class="form-group">
                                                <label class="sr-only" for="E-mail">E-mail</label>
                                                <input type="text" name="register_E-mail" class="form-control"  placeholder="Email">
                                            </div>
                                            <div class="form-group">
      ...
      <div class="container-fluid" id="header">
          <div class="row">
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#0847f5f1;color:#fff;font-weight:800;border:none;padding:15px;"> The Book Shop </div>
                  <ul>
      ...
      <div class="container-fluid">
          <div class="row">
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-6 text-center">
                          ...
                          <p>Aman Kumar Sharma(171500033)</p><br>
                          <p>Sandeep Singh(171500289)</p><br>
                          <p>Saurabh Chaudhary(171500298)</p>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-sm-4 col-md-3 col-lg-3 text-center">
                  <h2 style="color:#F5F8F9;">Follow Us At</h2>
                  <div>
